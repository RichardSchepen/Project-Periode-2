...
let userinput2 = document.getElementById('user-input-2'); // Gets user input 2 button element
let userinput3 = document.getElementById('user-input-3'); // Gets user input 3 button element
let userinput4 = document.getElementById('user-input-4'); // Gets user input 4 button element
let userinput5 = document.getElementById('user-input-5'); // Gets user input 5 button element
